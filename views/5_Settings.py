...
with col1:
    st.markdown(
        ...
        '<div style="font-size:14px; font-weight:600; color:#2B5A3E;">Export Backup</div>'
        '<div style="font-size:12px; color:#A09080;">Download all your data</div>'
        '</div>',
        unsafe_allow_html=True
    )
...
with col2:
    st.markdown(
        ...
        '<div style="font-size:14px; font-weight:600; color:#C48A1C;">Import Data</div>'
        '<div style="font-size:12px; color:#A09080;">Restore from backup</div>'
        '</div>',
        unsafe_allow_html=True
    )
